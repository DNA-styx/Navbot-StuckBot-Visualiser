...
HTML script and SourceMod Plugin containing AI-assisted code used to parse Day of Defeat:Source SourceMod logs for Navbot 'stuckbot' events, aggregate them into one file and display them in game to assist with finding poor waypointing.
